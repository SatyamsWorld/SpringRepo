...
public class MovieMgmtServiceImpl implements IMovieMgmtService {
	...
	public long fetchMoviesCount() {
		System.out.println("InMemory Proxu class name::" + movieRepo.getClass() + "..........."
				+ Arrays.toString(movieRepo.getClass().getInterfaces()));
		System.out.println("----------------");
	...
	/*
	 * public String updateMovie(Movie movie) { movieRepo.save(movie); return
	 * " movied updated"; }
	 */
	...
	/*
	 * @Override public String removeMovie(Movie movie) { movieRepo.delete(movie);
	 * return "Record deleted"; }
	 */
